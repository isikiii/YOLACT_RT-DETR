...
from yolact_rtdetr import YolactRTDETR
...
def evalimage(net:YolactRTDETR, path:str, save_path:str=None):
...
def evalimages(net:YolactRTDETR, input_folder:str, output_folder:str):
...
def evalvideo(net:YolactRTDETR, path:str, out_path:str=None):
...
def evaluate(net:YolactRTDETR, dataset, train_mode=False):
...
if __name__ == '__main__':
    ...
    with torch.no_grad():
        ...
        net = YolactRTDETR()
        net.load_state_dict(torch.load(args.trained_model))  # 如果你保存的是 state_dict
        net.eval()
        print(' Done.')
